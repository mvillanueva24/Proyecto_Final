            ...
            <form action="{{ route('books.update', $books->id) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        {{$errors->has('title') ? ' is-invalid' : ''}}" value="{{ $books->title }}" autofocus>
                        @if ($errors->has('title'))
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        {{$errors->has('author') ? ' is-invalid' : ''}}" value="{{ $books->author }}">
		        ...
		        <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        {{$errors->has('precio') ? ' is-invalid' : ''}}" value="{{ $books->precio }}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        {{$errors->has('stock') ? ' is-invalid' : ''}}" value="{{ $books->stock }}"> 
                        @if ($errors->has('stock'))
                            <span class="invalid-feedback" role="alert">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <div class="input-group mb-3">
                            ...
                            <select class="custom-select" id="categoria" name="categoria" value="{{ $books->genero }}">
                                <option selected>Choose...</option>
                                @foreach ($book1 as $book2)
                                <option name="categoria">{{ $book2->genero }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
